...
public class SongListTester {
	...
	public void testUsesTemplateProjectCorrectly() throws IOException {
		...
		assertTrue(
				"This project doesn't appear to be a copy of JavaCoreTemplate because the sbcccore library was not found in the lib directory.  See https://github.com/ProfessorStrenn/workspace-cs106-v3/blob/master/README.md for help on using the JavaCoreTemplate.",
				count > 0);
		totalScore += 2;
